...
public class ItemSearchActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Search = getIntent().getExtras().getString("Pesquisa");

        dal = new DAL(this);
        List<Categoria>  ArrayCategorias= dal.GetItensByItem(Search);
    ...
    private void FillList(List<Categoria> Itens)
    {
        ...
        listView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                intent.putExtra("Letra",Item.Grupo);
