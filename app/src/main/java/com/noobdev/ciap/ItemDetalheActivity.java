...
public class ItemDetalheActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView)(findViewById(R.id.txtLetra))).setText(Letra);
        ((TextView)(findViewById(R.id.txtGrupo))).setText(Categoria);
        ((TextView)(findViewById(R.id.txtCategoria))).setText(Grupo);
        ((TextView)(findViewById(R.id.txtDescricao))).setText(Descricao);
