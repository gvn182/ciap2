...
public class CategoriaActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayCategorias = dal.GetAllCategorias();
        Categoria[] cats = ArrayCategorias.toArray(new Categoria[ArrayCategorias.size()]);
        ...
        listView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                intent.putExtra("Categoria",Item.Descricao);
                intent.putExtra("Letra",Item.Titulo);
        ...
        ((EditText)findViewById(R.id.txtPesquisaCategoria)).setOnEditorActionListener(new TextView.OnEditorActionListener() {
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                if ((event != null && (event.getKeyCode() == KeyEvent.KEYCODE_ENTER)) || (actionId == EditorInfo.IME_ACTION_DONE)) {
                    ...
                    intent.putExtra("Pesquisa",v.getText().toString());
                    startActivity(intent);
                }
                return false;
            }
        ...
        ((ImageView)findViewById(R.id.btnSearch)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), ItemSearchActivity.class);
                intent.putExtra("Pesquisa", ((EditText)findViewById(R.id.txtPesquisaCategoria)).getText().toString());
                startActivity(intent);
            }
        });
    }
